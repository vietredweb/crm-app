...
if (
  ...
  notify(
    "The app has not been fully configured and you will not be able to login.  Go to https://crm.aesirx.io/install-guide/npm for instructions on how to configure your .env file",
    "error"
  );
}
